...
useSeoMeta({
  ...
  ogImage: "https://math-teacher-tarn.vercel.app/images/lesson2.png",
});
</script>
<template>
  <div class="m-4 flex flex-col gap-4" v-if="!route.hash">
    ...
    <NuxtImg
      src="https://math-teacher-tarn.vercel.app/images/lesson2.png"
      alt="Lesson"
